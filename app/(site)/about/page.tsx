    ...
    <>
      <main className="page-shell">
        ...
        <StickySectionNav
          ...
          layoutId="about-section-underline"
          ariaLabel="About sections"
          className="mt-8"
        />

        <section id="overview" className="scroll-mt-[calc(3.5rem+env(safe-area-inset-top,0px)+3.75rem)] sm:scroll-mt-[calc(4rem+env(safe-area-inset-top,0px)+4rem)] pt-10">
          <h1 className="font-display text-4xl font-bold tracking-tight text-ink sm:text-5xl">
            {morganProfile.name}
          </h1>
          <p className="mt-3 text-lg text-ink-muted">{morganProfile.title}</p>
          <p className="body-copy-sm mt-1">
          ...
          <p className="body-copy mt-4">{morganProfile.huspyLine}</p>
          <p className="body-copy-sm mt-4">{morganProfile.idealClientFilter}</p>
        </section>
        ...
        <section id="story" className="page-block space-y-4">
          ...
          <p className="body-copy">{morganProfile.about.careerStory}</p>
          <p className="body-copy">{morganProfile.about.internationalExperience}</p>
        </section>
        ...
        <section id="philosophy" className="page-block space-y-4">
          ...
          <p className="body-copy">{morganProfile.about.whyNumbersFirst}</p>
        </section>
        ...
        <section id="methodology" className="page-block space-y-4">
          ...
          <p className="body-copy">{morganProfile.about.methodology}</p>
          <p className="body-copy">{morganProfile.about.howClientsWork}</p>
          <p className="body-copy-sm">{morganProfile.currentMixNote}</p>
        </section>
